...
$$\textcolor{orange}{\text{⚠ Note: The exe installer is sometimes flagged as a virus. It was compiled using PyInstaller. 
If you do not trust the exe you can manually install it.⚠}}$$
